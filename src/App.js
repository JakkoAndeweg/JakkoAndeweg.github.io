...
class App extends React.Component {
  ...
  customAdvise()
  {
    ...
    else if (lowest==2)
    {
      ...
      {
        return 'Het aanleggen van een groen park of het aannemen van ondergerepresenteerde groepen klinkt als meer moeite dan het waard is, \t maar een beetje extra groen geeft werknemers een gevoel van rust die zorgt voor betere prestaties en het intergreren van nieuwe groepen zorgt voor een verse blik binnen uw bedrijf.\t plaats een aantal planten in uw pand of onderzoek welke posities door minder validen bekleed kunnen worden.'
      }
